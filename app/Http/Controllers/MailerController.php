...
class MailerController extends Controller
{
    ...
    {
        $ProductosArregloDes = Productos::where("descuento", ">", "0.0")->get();
        return Response::json($ProductosArregloDes);
    }


    public function EmailDescuento(Request $e)
    { 
        $busquedaEmail=User::all();
        $mensaje=strval($e->mensaje);
